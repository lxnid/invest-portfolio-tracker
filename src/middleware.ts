...
export async function middleware(request: NextRequest) {
  ...
  if (response) {
    ...
    response.headers.set(
      ...
      "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; connect-src 'self' https:; font-src 'self' https:; frame-src 'self' https://s.tradingview.com;",
    );
    response.headers.set(
